      ...
      {#if activeTab === "about"}
        <div class="settings-section">
          <div class="about-header">
            <h3 class="about-title">Claude Coach — Trail Edition (fork by Julien Picard)</h3>
            <span class="about-version">v{version}</span>
          </div>
          <p class="about-description">
            Coaching trail et endurance personnalisé. Plan adaptatif Wildstrubel, snapshot athlète,
        ...
        <div class="settings-section">
          ...
          <div class="about-author">
            <span class="author-name"
              >Julien Picard <span class="author-role">(fork &amp; adaptations)</span></span
            >
            <div class="author-links">
              <a
                href="https://github.com/pickswiss/claude-coach"
                target="_blank"
                rel="noopener"
                class="author-link">github.com/pickswiss</a
              >
            </div>
          </div>
          <div class="about-author" style="margin-top: 0.75rem;">
            <span class="author-name"
              >Felix Rieseberg <span class="author-role">(original)</span></span
            >
            <div class="author-links">
              <a
        ...
        <div class="settings-section">
          ...
          <div class="about-links">
            ...
            >
              ...
              Fork — pickswiss/claude-coach
            </a>
          </div>
        </div>

        <div class="settings-section">
          <h4 class="settings-section-title">Based on</h4>
          <div class="about-links">
            <a
            ...
            >
              ...
              Original — felixrieseberg/claude-coach
            </a>
          </div>
        </div>
